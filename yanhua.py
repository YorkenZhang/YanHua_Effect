...
def main():
    pygame.init()
    pygame.font.init()
    pygame.display.set_caption("致心中思念的那个人") # 标题
    background = pygame.image.load("./list/test.png") # 背景
    myfont = pygame.font.Font("./list/simkai.ttf",80)
    myfont1 = pygame.font.Font("./list/simkai.ttf", 30)
 
    testsurface = myfont.render("我好爱你",False,(251, 59, 85))
    testsurface1 = myfont1.render("By:你的名字", False, (251, 59, 85))

    sound_wav = pygame.mixer.music.load("./list/心墙.mp3")
